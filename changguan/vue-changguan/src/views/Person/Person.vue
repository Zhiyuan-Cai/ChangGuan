<template>
  <div class="person">
    <div class="header">
      <el-input v-model="name" style="width:500px;margin:10px" placeholder="请输入姓名"></el-input>
      <el-input v-model="jobNum" style="width:500px;margin:10px" placeholder="请输入工号"></el-input>
      <el-button type="primary" style="margin:10px" @click="search">查询</el-button>
      <!-- <el-button type="primary" style="margin:10px">
      <router-link to="/add-person" style="color:#fff">添加</router-link>
      </el-button> -->
      <el-button type="primary" style="margin:10px" @click="addPerson">添加
        <!-- <router-link to="/add-person" style="color:#fff">添加</router-link> -->
      </el-button>
    ...
    <div class="wrapper">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="jobNum" label="工号" width="180"></el-table-column>
        <el-table-column prop="sex" label="性别" width="180"></el-table-column>
        <el-table-column prop="telephone" label="手机号" width="180"></el-table-column>
        <el-table-column prop="department" label="部门" width="180" show-overflow-tooltip></el-table-column>
