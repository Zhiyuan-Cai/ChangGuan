<template>
    <div class="grid">
        <div class="header">
            ...
            <el-input v-model="name" style="width:500px;margin:10px" placeholder="请输入设备类别名称"></el-input>
            <el-button type="primary" style="margin:10px" @click="searchCategory">查询</el-button>
            <!-- <el-button type="primary" style="margin:10px">
      <router-link to="/add-person" style="color:#fff">添加</router-link>
      </el-button> -->
            <el-button type="primary" style="margin:10px" @click="addCategory">添加
                <!-- <router-link to="/add-person" style="color:#fff">添加</router-link> -->
            </el-button>
        ...
        <div class="wrapper">
            <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column prop="name" label="设备类别名称" width="180"></el-table-column>
        ...
        <CategoryDialog ref="dialog" :title="title" :rowData="rowData" />
    </div>
</template>
